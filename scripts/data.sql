...
/* USER_CATEGORIES */
insert user_categories (name) values ('Administrador');
insert user_categories (name) values ('Estándar');

/* USERS */
insert users (first_name, last_name, email, password, phone, img, category_id)
values ("Marcela", "Bustamante", "marcela@gmail.com", "$2a$10$0OEABTA3/HM1WIKs6i1nxO.7JI.xUzwGX.H2/gkUIvhkfKJ5q2HEK", 1145136566,
"1661528777919.png", 1);
insert users (first_name, last_name, email, password, phone, img, category_id)
...
4200, 0, 1, "/images/products/vinilos/vinilo-2.jpg", 3);
insert products (name, description, price, discount, special, img, category_id)
values ("Teléfono antiguo marca Bell", "Teléfono antiguo de la fábrica inglesa Bell, de principios de siglo XX, en óptimas condiciones de conservación. Adaptado para conectar
 a línea telefónica actual, funciona correctamente.", 4000, 0, 0, "/images/products/telefonos/telefono-1.jpg", 6);
insert products (name, description, price, discount, special, img, category_id)
...
caja lustrada, radio en funcionamiento. ¡Una joya para disfrutar!", 5000, 0, 1, "/images/products/tocadiscos/tocadiscos-1.jpg", 4);
insert products (name, description, price, discount, special, img, category_id)
...
En perfecto estado de funcionamiento. Contamos con los rollos de película para su uso (no incluídos).", 3500, 0, 0,  "/images/products/camaras/camara-1.jpg", 1);
insert products (name, description, price, discount, special, img, category_id)
...
2500, 0, 0, "/images/products/televisores/tv-1.jpg", 2);
insert products (name, description, price, discount, special, img, category_id)
...
partido del club de sus amores.", 2000, 0, 1, "/images/products/radios/radio-3.jpg", 5);
insert products (name, description, price, discount, special, img, category_id)
...
values ("Álbum Changes Two Bowie, David Bowie", "Álbum compilación de temas de David Bowie, editado en 1981. Perfecto estado.",
 2500, 0, 0, "/images/products/vinilos/vinilo-4.jpg", 3);
insert products (name, description, price, discount, special, img, category_id)
...
3000, 0, 0,  "/images/products/telefonos/telefono-3.jpg", 6);
insert products (name, description, price, discount, special, img, category_id)
...
values ("Bandeja tocadiscos portátil marca Technics, de fines de los años 80", "Original bandeja tocadiscos estilo maletín.
 Estuche revestido en cuero vacuno de primera calidad. Ideal para disfrutar de un atardecer en la playa moviendo el esqueleto. E", 2000, 20, 0,  "/images/products/tocadiscos/tocadiscos-6.jpg", 4);
insert products (name, description, price, discount, special, img, category_id)
...
Objeto decorativo, no funciona.", 4000, 20, 0, "/images/products/telefonos/telefono-5.jpg", 6);
insert products (name, description, price, discount, special, img, category_id)
...
Adquirido por Guillermo Coppola para ver el Mundial 78.", 5000, 0, 1, "/images/products/televisores/tv-4.jpg", 2);
...
insert product_colors (product_id, color_id) values (18, 9);
insert product_colors (product_id, color_id) values (19, 13);
insert product_colors (product_id, color_id) values (20, 1);
insert product_colors (product_id, color_id) values (20, 8);
insert product_colors (product_id, color_id) values (21, 5);
insert product_colors (product_id, color_id) values (21, 2);
insert product_colors (product_id, color_id) values (22, 2);
